...
int main() {
	...
	if (a + b + c + d == 0) { cout << "0" << endl; return 0; }

	if (!check(a, b, c, d)) { cout << "impossible" << endl; return 0; }
	if (one == 0) { cout << string(zero, '0') << endl; return 0; }
	if (zero == 0) { cout << string(one, '1') << endl; return 0; }
