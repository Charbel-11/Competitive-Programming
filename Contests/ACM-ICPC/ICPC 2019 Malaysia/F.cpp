//New approach when I build the new_mask online + ken 3ende ghalta abel ma hada ntabahla enno 
//I used binary search on the vector of pairs without sorting the initial vector
#include <iostream>
#include <vector>
#include <algorithm>
using namespace std;
