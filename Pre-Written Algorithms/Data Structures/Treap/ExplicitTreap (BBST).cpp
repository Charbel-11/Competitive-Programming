...
//Can be modified to find sum of biggest n-k numbers by adding a subtree sum variable to each node
...
//Adds all the nodes of from to to and deallocates the from treap
